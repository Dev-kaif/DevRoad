...
-- CreateIndex
CREATE INDEX "ChecklistItem_userId_phaseIndex_idx" ON "ChecklistItem"("userId", "phaseIndex");

-- CreateIndex
CREATE UNIQUE INDEX "ChecklistItem_userId_itemKey_key" ON "ChecklistItem"("userId", "itemKey");

-- CreateIndex
CREATE INDEX "Note_userId_scope_refKey_idx" ON "Note"("userId", "scope", "refKey");
