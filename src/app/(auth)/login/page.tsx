...
export default function LoginPage() {
    ...
    async function handleGoogle() {
        setLoading("google");
        await authClient.signIn.social({ provider: "google", callbackURL: "/roadmap" });
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <Button variant="outline" className="w-full text-sm" onClick={handleGoogle} disabled={!!loading}>
